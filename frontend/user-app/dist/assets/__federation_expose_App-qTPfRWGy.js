...
const ThemeContext = /*#__PURE__*/React$F.createContext({
  prefixes: {},
...
const TransitionGroupContext = React$E.createContext(null);
...
var Transition = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return (
      ...
      /* @__PURE__ */ React$D.createElement(TransitionGroupContext.Provider, {
        value: null
...
const {useCallback: useCallback$2,useRef: useRef$2} = React$C;
...
function hasChildOfType(children, type) {
  return React$r.Children.toArray(children).some(child => /*#__PURE__*/React$r.isValidElement(child) && child.type === type);
}
...
const Col = /*#__PURE__*/React$q.forwardRef(
...
const Container = /*#__PURE__*/React$p.forwardRef(({
  bsPrefix,
  fluid = false,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component = 'div',
...
const SelectableContext = /*#__PURE__*/React$o.createContext(null);
...
const NavContext = /*#__PURE__*/React$n.createContext(null);
...
const context = /*#__PURE__*/React$m.createContext(null);
...
const Feedback = /*#__PURE__*/React$l.forwardRef(
// Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
({
  as: Component = 'div',
  className,
...
const FormContext = /*#__PURE__*/React$k.createContext({});
const FormContext$1 = FormContext;

const React$j = await importShared('react');

const {useContext: useContext$9} = await importShared('react');
const FormCheckInput = /*#__PURE__*/React$j.forwardRef(({
  id,
  bsPrefix,
  className,
  type = 'checkbox',
...
const FormCheckLabel = /*#__PURE__*/React$i.forwardRef(({
  bsPrefix,
  className,
  htmlFor,
  ...props
...
const FormCheck = /*#__PURE__*/React$h.forwardRef(({
  id,
  bsPrefix,
  bsSwitchPrefix,
  inline = false,
...
const FormControl = /* @__PURE__ */ React$g.forwardRef(({
  bsPrefix,
  type,
  size,
  htmlSize,
...
const React$f = await importShared('react');
const FormFloating = /*#__PURE__*/React$f.forwardRef(({
  className,
  bsPrefix,
  as: Component = 'div',
  ...props
...
const FormGroup = /*#__PURE__*/React$e.forwardRef(({
  controlId,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component = 'div',
  ...props
...
const FormLabel = /* @__PURE__ */ React$d.forwardRef(({
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component = "label",
  bsPrefix,
  column = false,
...
const FormRange = /*#__PURE__*/React$c.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
...
const FormSelect = /*#__PURE__*/React$b.forwardRef(({
  bsPrefix,
  size,
  htmlSize,
  className,
...
const React$a = await importShared('react');
const FormText = /*#__PURE__*/React$a.forwardRef(
// Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
({
  bsPrefix,
  className,
...
const Switch = /*#__PURE__*/React$9.forwardRef((props, ref) => /*#__PURE__*/jsxRuntimeExports.jsx(FormCheck$1, {
  ...props,
  ref: ref,
  type: "switch"
}));
...
const FloatingLabel = /*#__PURE__*/React$8.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
...
const Form = /*#__PURE__*/React$7.forwardRef(({
  className,
  validated,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component = 'form',
...
const TabContext = /*#__PURE__*/React$6.createContext(null);
...
const NavItem$2 = /*#__PURE__*/React$5.forwardRef((_ref, ref) => {
  let {
...
const Nav$2 = /*#__PURE__*/React$4.forwardRef((_ref, ref) => {
  let {
      // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
      as: Component = 'div',
      onSelect,
...
const NavItem = /*#__PURE__*/React$3.forwardRef(({
  className,
  bsPrefix,
  as: Component = 'div',
  ...props
...
const NavLink = /*#__PURE__*/React$2.forwardRef(({
  bsPrefix,
  className,
  as: Component = Anchor$1,
  active,
...
const Nav = /*#__PURE__*/React$1.forwardRef((uncontrolledProps, ref) => {
  const {
    as = 'div',
